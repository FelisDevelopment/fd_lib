...
function FD.utils.requestAnimDict(animDict, timeout)
...
function FD.utils.requestAnimSet(animSet, timeout)
...
---@return number? model
function FD.utils.requestModel(model, timeout)
...
function FD.utils.requestStreamedTextureDict(textureDict, timeout)
...
function FD.utils.requestNamedPtfxAsset(fxName, timeout)
